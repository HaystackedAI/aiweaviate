...
def create_redshift_namespace():
    ...
    try:
        ...
        try:
            response = aws.redshift_client.get_namespace(namespaceName=REDSHIFT_NAMESPACE)
        ...
        response = aws.redshift_client.create_namespace(
        ...
        for attempt in range(max_attempts):
            try:
                namespace_response = aws.redshift_client.get_namespace(namespaceName=REDSHIFT_NAMESPACE)
